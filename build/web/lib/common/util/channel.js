...
var Channel = /** @class */ (function () {
    ...
    Channel.prototype.read = function () {
        ...
        if (this.value_que.length > 0) {
            var value_que_1 = this.value_que;
            var p = new Promise(function (resolve, rej) {
                setTimeout(function () { return resolve(value_que_1.shift()); }, 0); //immediately resolve 
            });
            return p;
        }
        else {
            ...
            var p = new Promise(function (resolve, reject) {
                _this.promise_que.push([resolve, reject]); //but save the resolver 
            });
    ...
    Channel.prototype.write = function (data) {
        if (this.promise_que.length > 0) {
            ...
            var _a = this.promise_que.shift(), resolve = _a[0], reject = _a[1];
            resolve(data);
        }
        else {
    ...
    Channel.prototype.log_data = function () {
