 ...
 * See class methods.
 */
var PortfolioBalancer = /** @class */ (function () {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        */
                        ...
                        if (!target_achieved) return [3 /*break*/, 2];
                        if (this.log_mode == "verbose") {
                            this.log("Target ratio already achieved. Returning");
                        }
                        return [2 /*return*/, { balanced: false, balance_needed: false, info: null }];
                    case 2:
                        ...
                        return [4 /*yield*/, this.do_market_trade(trade_type, base_market_amt)];
                    case 3:
                        result = _b.sent();
                        error = result.error, result_info = result.info;
                        return [2 /*return*/, { balanced: !error, balance_needed: true, info: result_info }];
                }
            });
        });
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.get_base_balance(base_asset)];
                    case 1:
                        base_amt = _b.sent();
                        return [4 /*yield*/, this.get_quote_balance(quote_asset)];
                    case 2:
                        quote_amt = _b.sent();
                        return [4 /*yield*/, this.get_base_price(base_asset, quote_asset)];
                    case 3:
                        base_price = _b.sent();
