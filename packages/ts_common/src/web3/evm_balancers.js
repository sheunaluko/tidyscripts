...
import { TxStatus } from "./smart_wallet";
/**
 * Creates an EVM balancer object
 */
var EVMBalancer = /** @class */ (function (_super) {
...
export { EVMBalancer };
var UniV2Balancer = /** @class */ (function (_super) {
    ...
    */
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, tokens.base_token_contract.balanceOf(this.wallet.address)];
                    case 1:
                        tmp = (_a.sent());
                        decimals = base_token.decimals;
                        return [2 /*return*/, Number(ethers.utils.formatUnits(tmp.toString(), decimals))];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        base_token = tokens.base_token;
                        quote_token = tokens.quote_token;
                        return [4 /*yield*/, tokens.quote_token_contract.balanceOf(this.wallet.address)];
                    case 1:
                        tmp = (_a.sent());
    ...
    UniV2Balancer.prototype.get_base_price = function (ba, qa) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.get_pool_reserves()];
                    case 1:
                        _a = _b.sent(), base_reserves = _a.base_reserves, quote_reserves = _a.quote_reserves;
                        return [2 /*return*/, quote_reserves / base_reserves];
                }
            });
        });
    };
    ...
    */
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.estimate_base_out(_amt)];
                    case 3:
                        output_info = _a.sent();
                        _a.label = 4;
                    case 4:
                        ...
                        return [4 /*yield*/, this.wallet.get_gas_overrides()];
                    case 5:
                        overrides = _a.sent();
                        overrides.gasLimit = ethers.BigNumber.from("200000");
                        this.log("Estimating gas");
                        return [4 /*yield*/, this.routerContract
                                .estimateGas
                    ...
                    case 7:
                        tx = _a.sent();
                        return [2 /*return*/, { tx: tx, output_info: output_info, gas_estimate: gas_estimate }];
                }
            });
        });
    };
    UniV2Balancer.prototype.do_swap = function (base_or_quote, amt, base_smart_send_ops) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.generate_swap_transaction(base_or_quote, amt)];
                    case 1:
                        ...
                        if (!(slippagePercent > max_slippage_percent)) return [3 /*break*/, 2];
                        //abort
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.wallet.smartSendTransaction(ops)];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.wallet.token_allowance_is_maxed(token_contract, router_address)];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.wallet.fully_approve_token(ops)];
                    case 1: return [2 /*return*/, (_a.sent())];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        tokens = this.tokens;
                        token_contract = tokens.quote_token_contract;
                        return [4 /*yield*/, this.approve_token(token_contract, base_smart_send_ops)];
                    case 1: return [2 /*return*/, (_a.sent())];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.base_token_approved()];
                    case 1:
                        if (!!(_a.sent())) return [3 /*break*/, 3];
                        this.log("Base token not approved...");
                        return [4 /*yield*/, this.approve_base_token(base_smart_send_ops)];
                    case 2:
                        base_result = _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
                        ...
                        _a.label = 4;
                    case 4: return [4 /*yield*/, this.quote_token_approved()];
                    case 5:
                        if (!!(_a.sent())) return [3 /*break*/, 7];
                        this.log("Quote token not approved...");
                        return [4 /*yield*/, this.approve_quote_token(base_smart_send_ops)];
                    case 6:
                    ...
                    case 8:
                        if ((base_result.status == TxStatus.Success) &&
                            ...
                            return [2 /*return*/, { success: false, data: { base_result: base_result, quote_result: quote_result } }];
                        }
                        return [2 /*return*/];
                }
            });
    ...
    UniV2Balancer.prototype.get_tx_gas_info = function (tx, usd_price) {
        ...
        var max_total_gas = Number(ethers.utils.formatEther(gasPrice.mul(gasLimit)));
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        base_token = tokens.base_token;
                        quote_token = tokens.quote_token;
                        return [4 /*yield*/, this.get_balance_data()];
                    case 1:
                        ...
                        amountIn = ethers.utils.parseUnits(String(amt), base_token.decimals);
                        path = [base_token.address, quote_token.address];
                        amountOutNoSlip = amt * base_price;
                        return [4 /*yield*/, this.routerContract.getAmountsOut(amountIn, path)];
                    case 2:
                        amounts = _b.sent();
                        amountOut = Number(ethers.utils.formatUnits(amounts[1], quote_token.decimals));
                        ...
                        minAmountOut = ethers.utils.parseUnits(String(minAmountOutNum), quote_token.decimals);
                        return [2 /*return*/, {
                                amounts: amounts,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = (_b.sent()), base_amt = _a.base_amt, quote_amt = _a.quote_amt, base_price = _a.base_price, portfolio_value = _a.portfolio_value, current_ratio = _a.current_ratio, ratio_error = _a.ratio_error, target_achieved = _a.target_achieved, target_base_amt = _a.target_base_amt, base_delta = _a.base_delta, trade_type = _a.trade_type, base_market_amt = _a.base_market_amt;
                        amountIn = ethers.utils.parseUnits(String(amt), quote_token.decimals);
                        path = [quote_token.address, base_token.address];
                        amountOutNoSlip = amt / base_price;
                        return [4 /*yield*/, this.routerContract.getAmountsOut(amountIn, path)];
                    case 2:
                        amounts = _b.sent();
                        amountOut = Number(ethers.utils.formatUnits(amounts[1], base_token.decimals));
                        slippageRatio = (amountOutNoSlip - amountOut) / amountOutNoSlip;
                        slippagePercent = slippageRatio * 100;
                        max_slippage_percent = this.params.max_slippage_percent;
                        minAmountOutNum = (amountOutNoSlip * (1 - max_slippage_percent / 100)).toFixed(base_token.decimals);
                        minAmountOut = ethers.utils.parseUnits(String(minAmountOutNum), base_token.decimals);
                        return [2 /*return*/, {
                                amounts: amounts,
                                amountOutNoSlip: amountOutNoSlip,
                                amountIn: amountIn,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        tokens = this.tokens;
                        return [4 /*yield*/, this.poolContract.getReserves()];
                    case 1:
                        tmp = _a.sent();
                        token0reserves = toEth(tmp[0], this.token0.decimals);
                        token1reserves = toEth(tmp[1], this.token1.decimals);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = trade_type;
                        switch (_a) {
                            case pbl.MarketTradeType.BUY: return [3 /*break*/, 1];
                            case pbl.MarketTradeType.SELL: return [3 /*break*/, 3];
                        }
                        return [3 /*break*/, 5];
                    case 1: return [4 /*yield*/, this.do_swap("QUOTE", base_amt, this.wallet.default_smart_send_base(0.05))];
                    case 2:
                        result = _b.sent();
                        return [3 /*break*/, 5];
                    case 3: return [4 /*yield*/, this.do_swap("BASE", base_amt, this.wallet.default_smart_send_base(0.05))];
                    case 4:
                        result = _b.sent();
                        return [3 /*break*/, 5];
                    case 5:
                        if (result.status == TxStatus.Success) {
                            return [2 /*return*/, { error: false, info: result }];
                        }
                        else {
                            return [2 /*return*/, { error: true, info: result }];
                        }
                        return [2 /*return*/];
                }
            });
