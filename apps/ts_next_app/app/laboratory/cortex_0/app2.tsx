...
/*
   ...
   Quite functional Interface using the traditional browser based speech recognition and TTS linked with 
   Open AI LLM. 

   Improvements: 
   - can try to improve the speech generation by using openai API, but convert the first sentence to speech, and while its being played convert the rest of the output to speech
